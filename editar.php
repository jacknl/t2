...
<form method="post" action="update.php">
	<div class="formulario editar">
		<table>
			<tr class="tr">
				<td>Nome: </td>
				<td><div class="nome"><input type="text" name="nome" placeholder="Mínimo 6 e Máximo 64 caractéres" value="<?php echo @$_SESSION['user']['nome']?>"></div></td>
			</tr>
			<tr class="tr">
				<td>Login: </td>
				<td><div class="login"><input type="text" name="login" placeholder="Mín 4 e Máx 32 caractéres com/sem underscore _" value="<?php echo @$_SESSION['user']['login']?>"></div></td>
			</tr>
			<tr class="tr">
				<td></td>
			...
			<tr class="tr">
				<td>Senha atual: </td>
				<td><div class="senha_atual"><input type="password" name="senha_atual" placeholder="Mínimo 6 e Máximo 32 caractéres"></div></td>
			</tr>
			<tr class="tr">
				<td>Nova senha: </td>
			...
			<tr class="tr">
				<td>E-mail: </td>
				<td><div class="email"><input type="text" name="email" placeholder="Mínimo 10 e Máximo 64 caractéres" value="<?php echo @$_SESSION['user']['email']?>"></div></td>
			</tr>
			<tr class="tr">
				<td>Captcha: </td>
				<td class="captcha">
